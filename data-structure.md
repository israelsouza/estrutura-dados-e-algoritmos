...
- [file](./scripts-univesp/primeira-estrutura.c)
- [file](./scripts-univesp/ponteiros.c)
- [file](./scripts-univesp/alocacao-memoria.c)
- [file](./scripts-univesp/primeira-estrutura-com-alocacao-memoria.c)
...
- [file](./scripts-univesp/lista-linear-sequencial.c)
...
- [file](./scripts-univesp/lista-linear-continuacao.c)

05 - Lista ligada (implementação estática)

- [file](./scripts-univesp/lista-ligada.c)
...
- [file](./scripts-univesp/lista-ligada-dinamica.c)

07 - Lista ligada circular com nó cabeça

- [file](./scripts-univesp/lista-ligada-no-cabeca.c)

08 - Pilha (implementação estática)

Estrutura linear onde elementos a serem inseridos e excluidos sempre ficam no topo

- [file](./scripts-univesp/pilha-estatica.c)

09 - Pilha (implementação dinâmica)

Testei fazer diferente, após o prof falar o método, primeiro tentei implementar sem o vídeo. Consegui, pegar a lógica com mais facilidade pegando exemplo da [lista ligada dinâmica](./scripts-univesp/lista-ligada-dinamica.c) e adaptando para a pilha. O ultimo, depois de tentativas primeiro, consegui implementar com sucesso!!!

- [file](./scripts-univesp/pilha-dinamica.c)
...
- [file](./scripts-univesp/fila.c)

12 - Fila (imp. dinâmica)

- [file](./scripts-univesp/fila-dinamica.c)
...
![IMG02](./attach/image-pilha.png)

- [file](./scripts-univesp/pilha-dupla.c)
...
- [file](./scripts-univesp/matriz-esparsa.c)

15 - Arvores (conceito base)

- [file](./scripts-univesp/arvore-binaria.c)
...
- [file](./scripts-univesp/arvore-naria.c)
...
- [file](./scripts-univesp/arvore-tries.c)
...
- [file](./scripts-univesp/arvore-avl.c)
...
- [file](./scripts-univesp/grafo-busca-profundidade.c)
...
- [file](./scripts-univesp/grafo-busca-largura.c)
...
- [file](./scripts-univesp/grafo-algoritmo-dijkstra.c)
